<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true" CodeFile="/Home/Home.aspx.cs" Inherits="Home"  EnableEventValidation="false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="LoginPlaceHolder" runat="server">
   <asp:Button runat="server" BackColor="White" ID="LoginButton" Text="SignIn" OnClick="LoginButton_Click" CssClass="CssLogins"/>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ShowContent" Runat="Server">
    <!-- Slider -->
