<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage/HomePage.master" AutoEventWireup="true" CodeFile="HomePage.aspx.cs" Inherits="HomePage" %>

<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
</asp:Content>
<asp:Content ID="Unorderedlist" ContentPlaceHolderID="List" runat="server">
...
<!-- Fresh Food  -->
    					...
    					data-responsive_offset="on"
					    >
                            <span>F</span>resh <span>F</span>ood 
					    </h2>
    					...
    					data-responsive_offset="on"
					    >
					    	Just search for the products or enter your diseases we will recommend you so that you can stay healthy.
					    </p>
...
<!--  -->
    					...
    					data-responsive_offset="on"
					    >
					    	<span class="child1">Healthy</span> <span class="child2">products</span>
					    </div>
...
<!--  -->
	...
	<div class="sec-item flex-w">
		...
		<div class="of-hidden size-w-2 respon2">
			<div class="hov-img1 pos-relative">
				<img src="../images/bg-item-03.jpg" alt="IMG">

				<a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
					<div class="wrap-pic-max-w">
						<img src="../images/icons/symbol-05.png" alt="IMG">
					</div>
					...
					<div class="block1">
						<div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
							...
							<div class="block1-content flex-col-c-m p-b-46">
								<a href="../product-single.html" class="txt-m-103 cl3 txt-center">
									Red pumpkin
								</a>
						...
						<div class="wrap-slick2">
							...
							<div class="slick2">
								<div class="item-slick2 p-all-15">
									<!-- item product2 -->
                                    <a href="../product-single.html"class="flex-w flex-str size-h-1 bo-all-1 bocl12 hov3 trans-04 m-b-30">	<div class="size-w-6 flex-c-m wrap-pic-max-s">
...
<a href="../product-single.html"class="flex-w flex-str size-h-1 bo-all-1 bocl12 hov3 trans-04 m-b-30">										<div class="size-w-6 flex-c-m wrap-pic-max-s">
									...
									<!-- item product2 --><a href="../product-single.html"class="flex-w flex-str size-h-1 bo-all-1 bocl12 hov3 trans-04 m-b-30"><div class="size-w-6 flex-c-m wrap-pic-max-s">
											<img src="../images/product-09.jpg" alt="IMG-PRODUCT">
										</div>
				...
				<div class="col-sm-10 col-md-6 col-lg-4 p-b-20 m-rl-auto-md">
					<div class="p-rl-10 p-rl-0-xl">
						...
						<div class="wrap-slick2">
							...
							<div class="slick2">
								<div class="item-slick2 p-all-15">
									<!-- item product2 --><a href="../product-single.html"class="flex-w flex-str size-h-1 bo-all-1 bocl12 hov3 trans-04 m-b-30">
			...
			<div class="wrap-footer flex-w p-t-60 p-b-62">
				...
				<div class="footer-col3">
					<ul>
						...
						<li class="p-b-16">
							<a href="../YourProfile/UserProfil.aspx" class="txt-s-101 cl6 hov-cl10 trans-04 p-tb-5">
